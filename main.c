...
int main(int argc, char *argv[])
{
    ...
    // ====================================  Search for search image in input image
    mainSearchImageOpenMp(searchImg, searchImgWidth, searchImgHeight, inputImg, inputImgWidth, inputImgHeight);
    // printf("Parallel execution time:%.4f", clock() - begin);
